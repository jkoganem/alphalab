...
class StrategyGenerator:
    ...
    def _get_temperature(self) -> float:
        ...
        GPT-5 family models only support the default temperature of 1.0.
        This method returns the correct temperature value based on the model.

        Returns:
            Temperature value to use for API calls
        """
        # All GPT-5 models (gpt-5, gpt-5-mini, gpt-5-nano) only support temperature=1.0
    ...
    def generate_ideas(
        ...
        prompt = self._build_idea_prompt(market_context, data_description, example_selector)
    ...
    def _build_idea_prompt(
        self, market_context: str | None, data_description: dict | None, example_selector=None
    ) -> str:
