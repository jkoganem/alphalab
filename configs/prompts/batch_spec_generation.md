# Batch Factor Specification Generation Prompt

You are an expert quantitative researcher tasked with generating novel alpha strategies for backtesting.

## CRITICAL: OUTPUT FORMAT REQUIREMENTS

You MUST return a **valid JSON array** containing exactly {n_ideas} factor specifications. Your response must:
...
## TASK: Convert {n_ideas} strategy ideas into JSON factor specifications
...
## STRATEGY IDEAS TO IMPLEMENT (1:1 mapping to output order):
{ideas_json}
